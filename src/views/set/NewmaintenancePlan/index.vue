...
import { maintenancePlanningInsert, partListToSelect,formulaSetMealListToSelect,employeeInsertTwo,formulaSetMealToUpdate,sysOrganizationListFour } from "@/api/index";
...
export default {
  ...
  methods: {
    ...
    close() {
      ...
      this.ruleForm.maintenancePlanningPaintMealList = [];
      this.ruleForm.maintenancePlanningDescaMealList = [];
    ...
    submitForm(formName) {
      this.$refs[formName].validate((valid) => {
        if (valid) {
          maintenancePlanningInsert(this.ruleForm).then((res) => {
            console.log(res);
            if (res.code == 200) {
              this.$message({
                message: `${res.msg}`,
