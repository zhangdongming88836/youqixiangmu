      ...
      <div class="contebn">
        ...
        >
         ...
         <el-form-item label="职位名称" prop="positionName">
            <el-input v-model="ruleForm.positionName" placeholder="请输入"></el-input>
          </el-form-item>
...
import { Email, Phon } from "../../../utils/verification";
 import { sysPositionUpdate, sysPositionToUpdate } from "@/api/index";
export default {
  ...
  methods: {
    ...
    open() {
      ...
      sysPositionToUpdate(this.ruleForm.id).then((res) => {
    ...
    submitForm(formName) {
      this.$refs[formName].validate((valid) => {
        if (valid) {
          sysPositionUpdate(this.ruleForm).then((res) => {
            if (res.code == 200) {
              this.$message({
                message: `${res.msg}`,
                type: "success",
